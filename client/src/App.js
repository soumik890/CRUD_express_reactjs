...
const updateEmpName=(id)=>{
  Axios.put('http://localhost:5000/updatenam',{emp_name:newName,id:id}).then(
    (res)=>{
    setemp_list(
      emp_list.map((val)=>{
      return val.id==id? {
...
const updateEmpAge=(id)=>{
  ...
  Axios.put('http://localhost:5000/updateage',{emp_age:newAge,id:id}).then(
    (res)=>{
    setemp_list(
      emp_list.map((val)=>{
      return val.id==id? {
...
const updateEmpPosition=(id)=>{
  ...
  Axios.put('http://localhost:5000/updatepos',{emp_position:newPosition,id:id}).then(
    (res)=>{
    setemp_list(
      emp_list.map((val)=>{
      return val.id==id? {
...
const updateEmpSalary=(id)=>{
  Axios.put('http://localhost:5000/updatesal',{emp_sal:newSalary,id:id}).then(
    (res)=>{
    setemp_list(
      emp_list.map((val)=>{
      return val.id==id? {
